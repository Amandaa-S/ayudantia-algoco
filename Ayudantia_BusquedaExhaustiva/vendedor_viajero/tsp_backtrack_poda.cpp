                       ...
                       std::vector<int> &mejor_ruta)
{
    ...
    for (int i = nivel; i < ruta_actual.size(); ++i)
    {
        ...
        if (nivel > 0)
        {
            ...
            {
                resolver_TSP_poda(ruta_actual, distancias, nivel + 1, costo_nuevo, mejor_costo, mejor_ruta);
            }
        }
        else
        {
            resolver_TSP_poda(ruta_actual, distancias, nivel + 1, costo_actual, mejor_costo, mejor_ruta);
        }
